...
public class RecipeIngredientListFragment extends Fragment {
    private static final String TAG = RecipeIngredientListFragment.class.getSimpleName();
    private static final String ARG_PARAM1 = "param1";
    private FragmentRecipeIngredientListBinding mBinding;
    ...
    public static RecipeIngredientListFragment newInstance (Recipe recipe) {
